...
RSpec.describe "dis_routed_generics/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit dis_routed_generic form" do
    render

    assert_select "form[action=?][method=?]", dis_routed_generic_path(@dis_routed_generic), "post" do
