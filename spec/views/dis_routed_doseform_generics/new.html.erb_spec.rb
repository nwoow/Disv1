...
RSpec.describe "dis_routed_doseform_generics/new", type: :view do
  before(:each) do
    assign(:dis_routed_doseform_generic, DisRoutedDoseformGeneric.new(
      :generic_id => 1,
      :rtd_gen_id => 1,
      :route_id => 1,
      :doseform_id => 1,
  ...
  it "renders new dis_routed_doseform_generic form" do
    render

    assert_select "form[action=?][method=?]", dis_routed_doseform_generics_path, "post" do
