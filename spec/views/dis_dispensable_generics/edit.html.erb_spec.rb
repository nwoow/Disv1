...
RSpec.describe "dis_dispensable_generics/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit dis_dispensable_generic form" do
    render

    assert_select "form[action=?][method=?]", dis_dispensable_generic_path(@dis_dispensable_generic), "post" do
