...
RSpec.describe "dis_manufacturers/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit dis_manufacturer form" do
    render

    assert_select "form[action=?][method=?]", dis_manufacturer_path(@dis_manufacturer), "post" do
