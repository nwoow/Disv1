...
RSpec.describe "dis_generics/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit dis_generic form" do
    render

    assert_select "form[action=?][method=?]", dis_generic_path(@dis_generic), "post" do
