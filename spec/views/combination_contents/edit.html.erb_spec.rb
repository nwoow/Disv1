...
RSpec.describe "combination_contents/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit combination_content form" do
    render

    assert_select "form[action=?][method=?]", combination_content_path(@combination_content), "post" do
