...
RSpec.describe "dis_generic_monographs/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit dis_generic_monograph form" do
    render

    assert_select "form[action=?][method=?]", dis_generic_monograph_path(@dis_generic_monograph), "post" do
