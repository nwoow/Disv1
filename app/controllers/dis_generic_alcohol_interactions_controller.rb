class DisGenericAlcoholInteractionsController < ApplicationController
  before_action :set_dis_generic_alcohol_interaction, only: [:show, :edit, :update, :destroy]

  # GET /dis_generic_alcohol_interactions
  # GET /dis_generic_alcohol_interactions.json
  def index
    @dis_generic_alcohol_interactions = DisGenericAlcoholInteraction.all
  end

  # GET /dis_generic_alcohol_interactions/1
  # GET /dis_generic_alcohol_interactions/1.json
  def show
  end

  # GET /dis_generic_alcohol_interactions/new
  def new
    @dis_generic_alcohol_interaction = DisGenericAlcoholInteraction.new
  end

  # GET /dis_generic_alcohol_interactions/1/edit
  def edit
  end

  # POST /dis_generic_alcohol_interactions
  # POST /dis_generic_alcohol_interactions.json
  def create
  ...
  # PATCH/PUT /dis_generic_alcohol_interactions/1
  # PATCH/PUT /dis_generic_alcohol_interactions/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /dis_generic_alcohol_interactions/1
  # DELETE /dis_generic_alcohol_interactions/1.json
  def destroy
  ...
  private
    ...
    def set_dis_generic_alcohol_interaction
      @dis_generic_alcohol_interaction = DisGenericAlcoholInteraction.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def dis_generic_alcohol_interaction_params
      params.require(:dis_generic_alcohol_interaction).permit(:generic_id, :alcohol_interaction_id, :status_id, :datasource_id)
    end
end
